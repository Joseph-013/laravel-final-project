                ...
                <div className="mt-16 flex flex-col space-y-16 lg:my-32 lg:space-y-32">
                    <div className="flex flex-col items-center space-y-8 lg:flex-row lg:space-x-8 lg:space-y-0">
                        <div className="w-full lg:w-1/2">
                            ...
                            <div className="mt-8 flex justify-center">
                                <Link href={`${route('products')}#stickers`} className="rounded-2xl bg-[#FFD700] px-6 py-4 text-xl font-extrabold text-primary shadow-md hover:bg-[#FFD700]/90 sm:text-2xl">
                                    Show me!
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col-reverse items-center space-y-8 space-y-reverse lg:flex-row lg:space-x-8 lg:space-y-0">
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <div className="mt-8 flex justify-center">
                                <Link href={`${route('products')}#cup-sleeves`} className="rounded-2xl bg-[#FFD700] px-6 py-4 text-xl font-extrabold text-primary shadow-md hover:bg-[#FFD700]/90 sm:text-2xl">
                                    Show me!
                                </Link>
                            </div>
                        </div>
